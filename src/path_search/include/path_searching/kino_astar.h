...
#define inf 1 >> 30
  ...
  typedef std::vector<FlatTrajData> KinoTrajData; // KinoTrajData是一个向量，其中的每个元素都是 FlatTrajData 结构体的实例
  ...
  private:
    ...
    double FindMinDistance(const Eigen::Vector3d &center);
